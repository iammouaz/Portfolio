...
declare class Statsbeat {
    ...
    private _totalRequestCount;
    private _totalSuccesfulRequestCount;
    private _totalFailedRequestCount;
    private _retryCount;
    private _exceptionCount;
    private _throttleCount;
    private _intervalRequestExecutionTime;
    ...
    countRequest(duration: number, success: boolean): void;
    countException(): void;
    countThrottle(): void;
    countRetry(): void;
